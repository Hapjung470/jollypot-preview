...
(function () {
  ...
  var TAB = {
    '홈': 'jollypot-v2-home-v14-15.html',
  ...
  if (/recipe-detail|recipe-upgraded/.test(p)) {
    add('.header .header-icon:first-of-type', 'jollypot-v2-home-v14-15.html');   // ← 뒤로가기
  ...
  if (p.indexOf('cook-mode') >= 0) {
    ...
    add('.done-home', 'jollypot-v2-home-v14-15.html');
  }
  ...
  if (p.indexOf('order-complete') >= 0) {
    add('.hd-close', 'jollypot-v2-home-v14-15.html');
