...
(function () {
  ...
  if (p.indexOf('home') >= 0) {
    ...
    add('.full-recipe-card', 'jollypot-v2-recipe-detail-v1-26.html');
    add('.compact-card', 'jollypot-v2-recipe-detail-v1-26.html');
    add('.continue-card', 'jollypot-v2-recipe-detail-v1-26.html');
    add('.deck-card-slot', 'jollypot-v2-recipe-detail-v1-26.html');
    add('.summary-cta', 'jollypot-v2-scrapbook-v11-17.html');
  }
  if (p.indexOf('search') >= 0) {
    add('.gcard', 'jollypot-v2-recipe-detail-v1-26.html');
    add('.pcard', 'jollypot-v2-product-detail-v3-4.html');
    add('.col-card', 'jollypot-v2-collection-detail-v5-4.html');
    add('.ac-row', 'jollypot-v2-recipe-detail-v1-26.html');
  }
  ...
  if (p.indexOf('collection-detail') >= 0) {
    add('.recipe-grid-item', 'jollypot-v2-recipe-detail-v1-26.html');
    add('.recipe-list-item', 'jollypot-v2-recipe-detail-v1-26.html');
  }
  ...
  if (p.indexOf('order-complete') >= 0) {
    ...
    add('.oc-sheet-more', 'jollypot-v2-recipe-detail-v1-26.html');
  }
  if (p.indexOf('fridge') >= 0) {
    add('.recipe-card', 'jollypot-v2-recipe-detail-v1-26.html');
  }
